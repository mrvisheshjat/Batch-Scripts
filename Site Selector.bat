@REM This is an application that lets you select from a list of sites. feel free to add some of your own sites.

@echo off
color 2f
title Site Selector by mrvisheshjat
:top
echo ************************************
echo.
echo Site Selector.
...
echo ***************************************************************
echo.
echo Thank You for using Site Selector by mrvisheshjat
echo.
echo ***************************************************************
pause
exit